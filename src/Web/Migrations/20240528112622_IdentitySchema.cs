        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "varchar(600)", unicode: false, maxLength: 600, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Subtotal = table.Column<decimal>(type: "decimal(4,0)", nullable: false),
                    Total = table.Column<decimal>(type: "decimal(4,0)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemDescription = table.Column<string>(type: "varchar(600)", unicode: false, maxLength: 600, nullable: false),
                    ...
                    LineTotal = table.Column<decimal>(type: "decimal(4,0)", nullable: false),
                    TaxDescription = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    TaxTotal = table.Column<decimal>(type: "decimal(4,0)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InvoiceItem_UnitOfMeasurement",
                        column: x => x.UnitOfMeasurement,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceItem_UnitOfMeasurement",
                table: "InvoiceItem",
